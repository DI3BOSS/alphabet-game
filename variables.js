const letters = [
    ...
    export {letters, welcomeSelectors, usernameSelectors, gameModeSelectors, gamePlaySelectors, endOfGameSelectors, audioSelectors};